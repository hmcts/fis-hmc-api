...
public enum PartyRole {
    C100APPLICANT1("Applicant 1", "C100", 1, Representing.CAAPPLICANT),
    C100APPLICANT2("Applicant 2", "C100", 2, Representing.CAAPPLICANT),
    C100APPLICANT3("Applicant 3", "C100", 3, Representing.CAAPPLICANT),
    C100APPLICANT4("Applicant 4", "C100", 4, Representing.CAAPPLICANT),
    C100APPLICANT5("Applicant 5", "C100", 5, Representing.CAAPPLICANT),
    C100APPLICANTSOLICITOR1("Applicant solicitor 1", "C100", 1, Representing.CAAPPLICANTSOLICITOR),
    C100APPLICANTSOLICITOR2("Applicant solicitor 2", "C100", 2, Representing.CAAPPLICANTSOLICITOR),
    C100APPLICANTSOLICITOR3("Applicant solicitor 3", "C100", 3, Representing.CAAPPLICANTSOLICITOR),
    C100APPLICANTSOLICITOR4("Applicant solicitor 4", "C100", 4, Representing.CAAPPLICANTSOLICITOR),
    C100APPLICANTSOLICITOR5("Applicant solicitor 5", "C100", 5, Representing.CAAPPLICANTSOLICITOR),
    C100RESPONDENT1("Respondent 1", "C100", 1, Representing.CARESPONDENT),
    C100RESPONDENT2("Respondent 2", "C100", 2, Representing.CARESPONDENT),
    C100RESPONDENT3("Respondent 3", "C100", 3, Representing.CARESPONDENT),
    C100RESPONDENT4("Respondent 4", "C100", 4, Representing.CARESPONDENT),
    C100RESPONDENT5("Respondent 5", "C100", 5, Representing.CARESPONDENT),
    C100RESPONDENTSOLICITOR1("Respondent solicitor 1", "C100", 1, Representing.CARESPONDENTSOLICITOR),
    C100RESPONDENTSOLICITOR2("Respondent solicitor 2", "C100", 2, Representing.CARESPONDENTSOLICITOR),
    C100RESPONDENTSOLICITOR3("Respondent solicitor 3", "C100", 3, Representing.CARESPONDENTSOLICITOR),
    C100RESPONDENTSOLICITOR4("Respondent solicitor 4", "C100", 4, Representing.CARESPONDENTSOLICITOR),
    C100RESPONDENTSOLICITOR5("Respondent solicitor 5", "C100", 5, Representing.CARESPONDENTSOLICITOR),
    C100OTHERPARTY1("Other people in the case 1", "C100", 1, Representing.CAOTHERPARTY),
    C100OTHERPARTY2("Other people in the case 2", "C100", 2, Representing.CAOTHERPARTY),
    C100OTHERPARTY3("Other people in the case 3", "C100", 3, Representing.CAOTHERPARTY),
    C100OTHERPARTY4("Other people in the case 4", "C100", 4, Representing.CAOTHERPARTY),
    C100OTHERPARTY5("Other people in the case 5", "C100", 5, Representing.CAOTHERPARTY),
    FL401APPLICANT("Applicant", "FL401", 1, Representing.DAAPPLICANT),
    FL401APPLICANTSOLICITOR("Applicant solicitor", "FL401", 1, Representing.DAAPPLICANTSOLICITOR),
    FL401RESPONDENT("Respondent", "FL401", 1, Representing.DARESPONDENT),
    FL401RESPONDENTSOLICITOR("Respondent solicitor", "FL401", 1, Representing.DARESPONDENTSOLICITOR);
