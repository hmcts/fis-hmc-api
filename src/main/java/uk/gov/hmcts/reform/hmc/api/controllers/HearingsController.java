...
public class HearingsController {
    ...
    @ApiOperation(value = "get hearings data")
    @ApiResponses(
            value = {
                @ApiResponse(
                        code = 200,
                        message = "get hearings data successfully"),
    ...
    @ApiOperation(value = "get hearings by case reference number")
    @ApiResponses(
            value = {
                @ApiResponse(
                        code = 200,
                        message = "get hearings by caseRefNo successfully"),
