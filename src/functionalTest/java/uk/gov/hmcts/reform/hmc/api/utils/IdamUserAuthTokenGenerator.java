...
@TestPropertySource("classpath:application_e2e.yaml")
@Service
public class IdamUserAuthTokenGenerator {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(IdamUserAuthTokenGenerator.class);
    ...
    public String getSecurityTokens() {
        ...
        try {
            ...
            return idamTokenResponse.getBody().getAccessToken();
