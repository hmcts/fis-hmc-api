...
@TestPropertySource(properties = {"idam.api.url=localhost:5000"})
...
public class IdamApiConsumerTest {
    ...
    public static final String BEARER_TOKEN = "Bearer test";

    @Autowired private IdamClient idamClient;
    ...
    public RequestResponsePact executeGetUserInfo(PactDslWithProvider builder) {
        ...
        return builder.given("I have obtained an access_token as a user", params)
                ...
                .headerFromProviderState("Authorization", "Bearer ${access_token}", BEARER_TOKEN)
    ...
    private PactDslJsonBody createAuthResponse() {
        ...
        return new PactDslJsonBody()
                .stringMatcher(
                        "access_token", TOKEN_REGEXP, "eyJ0eXAiOiJKV1QiLCJ6aXAiOiJOT05FI.AL_JD-")
                .stringMatcher(
                        "refresh_token",
                        TOKEN_REGEXP,
                ...
                .stringMatcher(
                        "id_token", TOKEN_REGEXP, "eyJ0e.XAiOiJKV1QiLCJra-WQiOiJiL082_T3ZWdjEre")
    ...
    private PactDslJsonBody createUserInfoResponse() {
        return new PactDslJsonBody()
                ...
                .minArrayLike(
                        "roles",
                        1,
                        PactDslJsonRootValue.stringType("caseworker-privatelaw-solicitor"),
                        1)
